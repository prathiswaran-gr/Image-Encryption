...
def correlation_analysis(image_path_plaintext, image_path_ciphertext, output_file):
    ...
    im0 = axs[0].imshow(plaintext_horizontal_corr, cmap='hot', interpolation='nearest')
    ...
    axs[1].imshow(plaintext_vertical_corr, cmap='hot', interpolation='nearest')
    axs[1].set_title('Vertical Correlation')


    # Plot diagonal correlation
    axs[2].imshow(plaintext_diagonal_corr, cmap='hot', interpolation='nearest')
    axs[2].set_title('Diagonal Correlation')
